...
int main()
{
    ...
    *pPointer = 10;// assign a value to the first element
    ...
    /*inclement the pointer using pointer using pointer arithmentic to assign the address of the second element to the pointer*/
    pPointer++;
  ...
  pPointer = &numbersArray[2];
    *pPointer =30; //assign a value to the third element
    ...
    /*asssign the address of the firelement of the fourth element to the pointer using pointer  arithmetic  */
    ...
    *pPointer = 40; // assign a value to the fourth element
    ...
    /*assign a value to the fifth element using inderection and pointer pointer  arithmwtic*/
    *(pPointer+4) = 50;
